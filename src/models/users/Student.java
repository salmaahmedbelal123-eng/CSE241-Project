...
public class Student {
    ...
    private LocalDate birth = LocalDate.of (birthday , birthmonth , birthyear );
    Gender gender;
    int size1;
    ...
    void submission(int size1){
        ...
        for(int i = 0; i < size1 ; i++ ){
            System.out.print("Enter question #" + (i+1) + "answer : ");
           answers[i] =  input.nextLine();


        }
        System.out.println("you have submitted your assignment successfully !!");
